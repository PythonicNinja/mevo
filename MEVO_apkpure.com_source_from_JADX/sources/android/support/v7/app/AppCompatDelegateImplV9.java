...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    class C02465 implements Runnable {
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C09401());
                return;
            }
            AppCompatDelegateImplV9.this.mActionModeView.setAlpha(1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    class C05962 implements OnApplyWindowInsetsListener {
        C05962() {
        }
    ...
    class C05973 implements OnFitSystemWindowsListener {
        C05973() {
        }
    ...
    class C05984 implements OnAttachListener {
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C09421 extends ViewPropertyAnimatorListenerAdapter {
            C09421() {
            }
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C09421());
            }
    ...
    class C09416 extends ViewPropertyAnimatorListenerAdapter {
        C09416() {
        }
        ...
        if (obtainStyledAttributes.hasValue(C0249R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view, new C05962());
                } else {
                    ((FitWindowsViewGroup) view).setOnFitSystemWindowsListener(new C05973());
                }
            ...
            contentFrameLayout.setAttachListener(new C05984());
            return view;
        }
        obtainStyledAttributes.recycle();

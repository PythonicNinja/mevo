...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C09431();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C09442();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C06003();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C06003 implements ViewPropertyAnimatorUpdateListener {
        C06003() {
        }
    ...
    class C09431 extends ViewPropertyAnimatorListenerAdapter {
        C09431() {
        }
    ...
    class C09442 extends ViewPropertyAnimatorListenerAdapter {
        C09442() {
        }

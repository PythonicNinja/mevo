...
import android.support.v7.recyclerview.C0252R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C02973();
    ...
    static class C02973 implements Interpolator {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C06321();
        ...
        private final Callback mVerticalBoundCheckCallback = new C06332();
        private int mWidth;
        ...
        class C06321 implements Callback {
            C06321() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0252R.styleable.RecyclerView, i, i2);
            properties.orientation = context.getInt(C0252R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = context.getInt(C0252R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = context.getBoolean(C0252R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = context.getBoolean(C0252R.styleable.RecyclerView_stackFromEnd, false);
            context.recycle();
            return properties;
        }
    ...
    class C06294 implements ProcessCallback {
        C06294() {
        }
    ...
    class C06305 implements Callback {
        C06305() {
        }
    ...
    class C06316 implements Callback {
        C06316() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02981 implements ClassLoaderCreator<SavedState> {
            C02981() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C02951();
        ...
        this.mItemAnimatorRunner = new C02962();
        this.mViewInfoProcessCallback = new C06294();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0252R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0252R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0252R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0252R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0252R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0252R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0252R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0252R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C06305());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C06316());
    }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (!(stateListDrawable == null || drawable == null || stateListDrawable2 == null)) {
            if (drawable2 != null) {
                ...
                FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0252R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0252R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0252R.dimen.fastscroll_margin));
                return;
            }
        }

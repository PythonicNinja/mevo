...
public class LinearLayoutCompat extends ViewGroup {
    ...
    void measureVertical(int i, int i2) {
        ...
        while (true) {
            ...
            if (virtualChildAt2 == null) {
                ...
                if (virtualChildAt2.getVisibility() == 8) {
                    ...
                    int i23;
                    if (mode2 == ErrorDialogData.SUPPRESSED && layoutParams.height == 0 && layoutParams.weight > 0.0f) {
                        i7 = r7.mTotalLength;
                        i23 = i13;
                    ...
                    if (mode2 >= i11 || layoutParams.weight <= 0.0f) {
                        Object obj4;
                        if (mode == ErrorDialogData.SUPPRESSED || layoutParams.width != -1) {
                            obj4 = null;
                        } else {
                            obj4 = 1;
                            obj3 = 1;
        ...
        if (obj == null) {
            if (i9 == 0 || f <= 0.0f) {
                        ...
                        if (virtualChildAt3 != null) {
                            if (virtualChildAt3.getVisibility() != 8) {
                                if (((LayoutParams) virtualChildAt3.getLayoutParams()).weight > 0.0f) {
                                    virtualChildAt3.measure(MeasureSpec.makeMeasureSpec(virtualChildAt3.getMeasuredWidth(), ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(virtualChildCount, ErrorDialogData.SUPPRESSED));
                                }
                            }
                        }
                    }
                ...
                i12 = i8;
                virtualChildCount = i;
                if (obj2 == null || mode == ErrorDialogData.SUPPRESSED) {
                    i7 = i12;
                }
                ...
                if (f5 > 0.0f) {
                    ...
                    if (layoutParams2.height == 0) {
                        ...
                        if (i16 == 1073741824) {
                            ...
                            virtualChildAt.measure(i13, MeasureSpec.makeMeasureSpec(i27, ErrorDialogData.SUPPRESSED));
    ...
    void measureHorizontal(int i, int i2) {
        ...
        int i8 = ErrorDialogData.SUPPRESSED;
        Object obj = mode == ErrorDialogData.SUPPRESSED ? 1 : null;
        float f = 0.0f;
        int i9 = 0;
        int i10 = 0;
        int i11 = 0;
        ...
        if (obj2 == null) {
            if (baseline == 0 || f <= 0.0f) {
                i3 = Math.max(i8, i5);
                if (z && mode != ErrorDialogData.SUPPRESSED) {
                    for (i8 = 0; i8 < virtualChildCount; i8++) {
                        View virtualChildAt3 = getVirtualChildAt(i8);
                        if (virtualChildAt3 != null) {
                            if (virtualChildAt3.getVisibility() != 8) {
                                if (((LayoutParams) virtualChildAt3.getLayoutParams()).weight > 0.0f) {
                                    virtualChildAt3.measure(MeasureSpec.makeMeasureSpec(i10, ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(virtualChildAt3.getMeasuredHeight(), ErrorDialogData.SUPPRESSED));
                                }
                            }
                        }
                    }
                ...
                baseline = i2;
                if (obj3 == null || mode2 == ErrorDialogData.SUPPRESSED) {
                    i3 = measuredHeight;
                }
        ...
        while (i3 < virtualChildCount) {
            ...
            if (virtualChildAt4 != null) {
                if (virtualChildAt4.getVisibility() != 8) {
                    ...
                    if (f5 > 0.0f) {
                        ...
                        if (layoutParams3.width == 0) {
                            ...
                            if (mode == ErrorDialogData.SUPPRESSED) {
                                ...
                                virtualChildAt4.measure(MeasureSpec.makeMeasureSpec(combineMeasuredStates, ErrorDialogData.SUPPRESSED), i8);
                    ...
                    Object obj8 = (mode2 == ErrorDialogData.SUPPRESSED || layoutParams3.height != -1) ? null : 1;

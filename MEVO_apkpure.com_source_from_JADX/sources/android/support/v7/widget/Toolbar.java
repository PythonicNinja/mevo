...
public class Toolbar extends ViewGroup {
    ...
    class C06351 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C06351() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C03171 implements ClassLoaderCreator<SavedState> {
            C03171() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuViewItemClickListener = new C06351();
        this.mShowOverflowMenuRunnable = new C03152();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new C03163());
        }
    }

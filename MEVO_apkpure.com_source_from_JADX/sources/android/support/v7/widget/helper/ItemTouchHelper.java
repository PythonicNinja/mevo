...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C06362();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C03211();
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C03231();
        private static final Interpolator sDragViewScrollCapInterpolator = new C03242();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: android.support.v7.widget.helper.ItemTouchHelper$Callback$1 */
        static class C03231 implements Interpolator {
        ...
        static class C03242 implements Interpolator {
            public float getInterpolation(float f) {
                f -= 1.0f;
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0252R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C03251 implements AnimatorUpdateListener {
            C03251() {
            }
    ...
    class C06362 implements OnItemTouchListener {
        C06362() {
        }
    ...
    class C06385 implements ChildDrawingOrderCallback {
        C06385() {
        }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = recyclerView.getDimension(C0252R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = recyclerView.getDimension(C0252R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (viewHolder2 != this.mSelected || i2 != r11.mActionState) {
            ...
            if (r11.mSelected != null) {
                ...
                if (viewHolder3.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c06373 = new RecoverAnimation(viewHolder3, i6, i3, f2, f3, f, signum) {
                        public void onAnimationEnd(Animator animator) {
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C06385();
            }

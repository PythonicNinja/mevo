    ...
    public void runPendingAnimations() {
        ...
        if (isEmpty != 0 || isEmpty2 != 0 || isEmpty4 != 0 || isEmpty3 != 0) {
            ...
            if (isEmpty2 != 0) {
                ...
                if (isEmpty != 0) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, c02781, getRemoveDuration());
                } else {
                    c02781.run();
                }
            }
            if (isEmpty3 != 0) {
                ...
                if (isEmpty != 0) {
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c02781, getRemoveDuration());
                } else {
                    c02781.run();
                }
            }
            if (isEmpty4 != 0) {
                ...
                ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, c02803, removeDuration + Math.max(moveDuration, j));
            }
        }
    }

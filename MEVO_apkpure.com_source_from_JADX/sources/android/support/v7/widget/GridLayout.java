...
import android.support.v7.gridlayout.C0251R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0251R.styleable.GridLayout_alignmentMode;
    public static final int ALIGN_BOUNDS = 0;
    public static final int ALIGN_MARGINS = 1;
    public static final Alignment BASELINE = new C06227();
    public static final Alignment BOTTOM = TRAILING;
    static final int CAN_STRETCH = 2;
    public static final Alignment CENTER = new C06206();
    private static final int COLUMN_COUNT = C0251R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0251R.styleable.GridLayout_columnOrderPreserved;
    ...
    public static final Alignment FILL = new C06238();
    public static final int HORIZONTAL = 0;
    static final int INFLEXIBLE = 0;
    private static final Alignment LEADING = new C06173();
    ...
    static final Printer NO_PRINTER = new C02891();
    private static final int ORIENTATION = C0251R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT = createSwitchingAlignment(END, START);
    private static final int ROW_COUNT = C0251R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0251R.styleable.GridLayout_rowOrderPreserved;
    public static final Alignment START = LEADING;
    public static final Alignment TOP = LEADING;
    private static final Alignment TRAILING = new C06184();
    public static final int UNDEFINED = Integer.MIN_VALUE;
    static final Alignment UNDEFINED_ALIGNMENT = new C06162();
    static final int UNINITIALIZED_HASH = 0;
    private static final int USE_DEFAULT_MARGINS = C0251R.styleable.GridLayout_useDefaultMargins;
    ...
    static class C02891 implements Printer {
        ...
        private String arcsToString(List<Arc> list) {
            ...
            for (Arc arc : list) {
                ...
                if (i < i2) {
                    ...
                    stringBuilder2.append(Operation.MINUS);
                    stringBuilder2.append(str);
                    stringBuilder2.append(i);
                    stringBuilder2.append(Operation.GREATER_THAN_OR_EQUALS);
                } else {
                    stringBuilder2 = new StringBuilder();
                    stringBuilder2.append(str);
                    stringBuilder2.append(i);
                    ...
                    stringBuilder2.append(str);
                    stringBuilder2.append(i2);
                    stringBuilder2.append(Operation.LESS_THAN_OR_EQUALS);
                    i3 = -i3;
                }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0251R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0251R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0251R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0251R.styleable.GridLayout_Layout_layout_columnWeight;
        ...
        private static final int GRAVITY = C0251R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0251R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0251R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0251R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0251R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0251R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0251R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0251R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        private void reInitSuper(Context context, AttributeSet attributeSet) {
            context = context.obtainStyledAttributes(attributeSet, C0251R.styleable.GridLayout_Layout);
            try {
        ...
        private void init(Context context, AttributeSet attributeSet) {
            ...
            try {
                ...
                this.columnSpec = GridLayout.spec(context.getInt(COLUMN, Integer.MIN_VALUE), context.getInt(COLUMN_SPAN, DEFAULT_SPAN_SIZE), GridLayout.getAlignment(attributeSet, true), context.getFloat(COLUMN_WEIGHT, 0.0f));
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null) {
                if (getClass() == obj.getClass()) {
                    ...
                    return this.columnSpec.equals(layoutParams.columnSpec) && this.rowSpec.equals(layoutParams.rowSpec) != null;
                }
            }
            return false;
        }
    ...
    public static class Spec {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null) {
                if (getClass() == obj.getClass()) {
                    Spec spec = (Spec) obj;
                    return this.alignment.equals(spec.alignment) && this.span.equals(spec.span) != null;
                }
            }
            return false;
        }
    ...
    static class C06162 extends Alignment {
    ...
    static class C06173 extends Alignment {
        public int getAlignmentValue(View view, int i, int i2) {
            return 0;
        }
    ...
    static class C06184 extends Alignment {
        public int getAlignmentValue(View view, int i, int i2) {
            return i;
        }
    ...
    static class C06206 extends Alignment {
        public int getAlignmentValue(View view, int i, int i2) {
            return i >> 1;
        }
    ...
    static class C06227 extends Alignment {

        /* renamed from: android.support.v7.widget.GridLayout$7$1 */
        class C06211 extends Bounds {
            private int size;
    ...
    static class C06238 extends Alignment {
        public int getAlignmentValue(View view, int i, int i2) {
            return Integer.MIN_VALUE;
        }
    ...
    public GridLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0251R.dimen.default_gap);
        context = context.obtainStyledAttributes(attributeSet, C0251R.styleable.GridLayout);
        try {
    ...
    private void measureChildWithMargins2(View view, int i, int i2, int i3, int i4) {
        view.measure(getChildMeasureSpec(i, getTotalMargin(view, true), i3), getChildMeasureSpec(i2, getTotalMargin(view, 0), i4));
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i7 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int i16 = measurement;
                View view = childAt;
                i13 = bounds3.getOffset(r6, childAt, alignment3, measurement + i14, true);
                int i17 = i15;
                View view2 = view;
                i8 = childCount;
                childCount = i17;
                ...
                if (!(paddingBottom == view2.getMeasuredWidth() && measurement2 == view2.getMeasuredHeight())) {
                    view2.measure(MeasureSpec.makeMeasureSpec(paddingBottom, ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(measurement2, ErrorDialogData.SUPPRESSED));
                }

        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (r0.mBuilder.mLargeIcon != null) {
                if (VERSION.SDK_INT >= 16) {
                    ...
                    remoteViews.setImageViewBitmap(C0010R.id.icon, r0.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0010R.id.icon, 8);
                }
                if (z && r0.mBuilder.mNotification.icon != 0) {
                    dimensionPixelSize = resources.getDimensionPixelSize(C0010R.dimen.notification_right_icon_size);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(C0010R.dimen.notification_small_icon_background_padding) * 2);
                    if (VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0010R.id.right_icon, createIconWithBackground(r0.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, r0.mBuilder.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0010R.id.right_icon, createColoredBitmap(r0.mBuilder.mNotification.icon, -1));
                    }
                ...
                remoteViews.setViewVisibility(C0010R.id.icon, 0);
                if (VERSION.SDK_INT >= 21) {
                    remoteViews.setImageViewBitmap(C0010R.id.icon, createIconWithBackground(r0.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0010R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0010R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0010R.dimen.notification_small_icon_size_as_large), r0.mBuilder.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0010R.id.icon, createColoredBitmap(r0.mBuilder.mNotification.icon, -1));
                }
            }
            if (r0.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C0010R.id.title, r0.mBuilder.mContentTitle);
            }
            if (r0.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C0010R.id.text, r0.mBuilder.mContentText);
                obj = 1;
            } else {
                obj = null;
            }
            ...
            if (r0.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0010R.id.info, r0.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0010R.id.info, 0);
            } else if (r0.mBuilder.mNumber > 0) {
                if (r0.mBuilder.mNumber > resources.getInteger(C0010R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0010R.id.info, resources.getString(C0010R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0010R.id.info, NumberFormat.getIntegerInstance().format((long) r0.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0010R.id.info, 0);
            } else {
                ...
                if (r0.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                    remoteViews.setTextViewText(C0010R.id.text, r0.mBuilder.mSubText);
                    if (r0.mBuilder.mContentText == null) {
                        remoteViews.setTextViewText(C0010R.id.text2, r0.mBuilder.mContentText);
                        ...
                        if (r0.mBuilder.getWhenIfShowing() != 0) {
                            ...
                            remoteViews.setLong(C0010R.id.time, "setTime", r0.mBuilder.getWhenIfShowing());
                        } else {
                            remoteViews.setViewVisibility(C0010R.id.chronometer, 0);
                            remoteViews.setLong(C0010R.id.chronometer, "setBase", r0.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            remoteViews.setBoolean(C0010R.id.chronometer, "setStarted", true);
                        }
                        remoteViews.setViewVisibility(C0010R.id.right_side, z4 ? 0 : 8);
                        dimensionPixelSize = C0010R.id.line3;
                        if (obj2 == null) {
                            i2 = 8;
                        }

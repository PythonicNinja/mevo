...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C05741 implements StyleExtractor<FontInfo> {
        C05741() {
        }
    ...
    class C05752 implements StyleExtractor<FontFileResourceEntry> {
        C05752() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fontInfoArr, int i) {
        return (FontInfo) findBestFont(fontInfoArr, i, new C05741());
    }
...
*/
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i) {
        return (FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i, new C05752());
    }

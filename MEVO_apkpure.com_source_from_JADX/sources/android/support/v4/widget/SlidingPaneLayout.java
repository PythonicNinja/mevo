        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    mode = MeasureSpec.makeMeasureSpec(paddingLeft - i6, ErrorDialogData.SUPPRESSED);
                } else {
                ...
                if (layoutParams.height == -2) {
                    ...
                    i5 = MeasureSpec.makeMeasureSpec(paddingTop, ErrorDialogData.SUPPRESSED);
                } else {
                    i5 = MeasureSpec.makeMeasureSpec(layoutParams.height, ErrorDialogData.SUPPRESSED);
                }
                        ...
                        if (!z2 || childAt2 == slidingPaneLayout.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (layoutParams2.width != 0) {
                                    ...
                                    if (z2) {
                                        i7 = mode;
                                        childAt2.measure(MeasureSpec.makeMeasureSpec(i6 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i4))) / f)), ErrorDialogData.SUPPRESSED), i5);
                                        mode2++;
                                        mode = i7;
                                        i5 = 8;
                                    } else {
                                        ...
                                        i7 = mode;
                                        mode = MeasureSpec.makeMeasureSpec(i8, ErrorDialogData.SUPPRESSED);
                                        if (i6 != i8) {
                                    ...
                                    makeMeasureSpec = MeasureSpec.makeMeasureSpec(paddingTop, ErrorDialogData.SUPPRESSED);
                                } else {
                            ...
                            if (obj == null) {
                                ...
                                i8 = MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), ErrorDialogData.SUPPRESSED);
                            } else if (layoutParams2.height == -2) {
                                i8 = MeasureSpec.makeMeasureSpec(paddingTop, Integer.MIN_VALUE);
                                i9 = ErrorDialogData.SUPPRESSED;
                            } else if (layoutParams2.height == -1) {
                                i9 = ErrorDialogData.SUPPRESSED;
                                i8 = MeasureSpec.makeMeasureSpec(paddingTop, ErrorDialogData.SUPPRESSED);
                            } else {
                                i9 = ErrorDialogData.SUPPRESSED;
                                i8 = MeasureSpec.makeMeasureSpec(layoutParams2.height, ErrorDialogData.SUPPRESSED);
                            }

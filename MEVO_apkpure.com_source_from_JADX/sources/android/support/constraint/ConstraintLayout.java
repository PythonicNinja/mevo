...
*/
            ...
            r9.widget = r1;
            r9.helped = r2;
            r1 = android.support.constraint.C0012R.styleable.ConstraintLayout_Layout;
    ...
    public void setDesignInformation(int i, Object obj, Object obj2) {
        if (i == 0 && (obj instanceof String) != 0 && (obj2 instanceof Integer) != 0) {
            ...
            obj = (String) obj;
            i = obj.indexOf(Operation.DIVISION);
            if (i != -1) {
...
*/
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (obj != null && mode == Integer.MIN_VALUE && mode2 == ErrorDialogData.SUPPRESSED && size >= r0.mLastMeasureWidth) {
            i3 = r0.mLastMeasureHeight;
        }
        if (obj != null && mode == ErrorDialogData.SUPPRESSED && mode2 == Integer.MIN_VALUE && size == r0.mLastMeasureWidth) {
                            ...
                            if (view.getVisibility() != 8) {
                                if (obj == null || !constraintWidget.getResolutionWidth().isResolved() || !constraintWidget.getResolutionHeight().isResolved()) {
                                    if (layoutParams.width == -2 && layoutParams.horizontalDimensionFixed) {
                                        ...
                                        mode2 = MeasureSpec.makeMeasureSpec(constraintWidget.getWidth(), ErrorDialogData.SUPPRESSED);
                                    }

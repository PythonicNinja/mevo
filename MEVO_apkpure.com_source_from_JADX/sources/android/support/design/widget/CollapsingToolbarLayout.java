...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public static class LayoutParams extends android.widget.FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0019R.styleable.CollapsingToolbarLayout_Layout);
            this.mCollapseMode = context.getInt(C0019R.styleable.CollapsingToolbarLayout_Layout_layout_collapseMode, 0);
            setParallaxMultiplier(context.getFloat(C0019R.styleable.CollapsingToolbarLayout_Layout_layout_collapseParallaxMultiplier, DEFAULT_PARALLAX_MULTIPLIER));
            context.recycle();
        }
    ...
    class C05591 implements OnApplyWindowInsetsListener {
        C05591() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0019R.styleable.CollapsingToolbarLayout, i, C0019R.style.Widget_Design_CollapsingToolbar);
        this.mCollapsingTextHelper.setExpandedTextGravity(context.getInt(C0019R.styleable.CollapsingToolbarLayout_expandedTitleGravity, 8388691));
        this.mCollapsingTextHelper.setCollapsedTextGravity(context.getInt(C0019R.styleable.CollapsingToolbarLayout_collapsedTitleGravity, 8388627));
        attributeSet = context.getDimensionPixelSize(C0019R.styleable.CollapsingToolbarLayout_expandedTitleMargin, 0);
        ...
        if (context.hasValue(C0019R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart) != null) {
            this.mExpandedMarginStart = context.getDimensionPixelSize(C0019R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart, 0);
        }
        if (context.hasValue(C0019R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd) != null) {
            this.mExpandedMarginEnd = context.getDimensionPixelSize(C0019R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd, 0);
        }
        if (context.hasValue(C0019R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop) != null) {
            this.mExpandedMarginTop = context.getDimensionPixelSize(C0019R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop, 0);
        }
        if (context.hasValue(C0019R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom) != null) {
            this.mExpandedMarginBottom = context.getDimensionPixelSize(C0019R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom, 0);
        }
        this.mCollapsingTitleEnabled = context.getBoolean(C0019R.styleable.CollapsingToolbarLayout_titleEnabled, true);
        setTitle(context.getText(C0019R.styleable.CollapsingToolbarLayout_title));
        ...
        if (context.hasValue(C0019R.styleable.CollapsingToolbarLayout_expandedTitleTextAppearance) != null) {
            this.mCollapsingTextHelper.setExpandedTextAppearance(context.getResourceId(C0019R.styleable.CollapsingToolbarLayout_expandedTitleTextAppearance, 0));
        }
        if (context.hasValue(C0019R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance) != null) {
            this.mCollapsingTextHelper.setCollapsedTextAppearance(context.getResourceId(C0019R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance, 0));
        }
        this.mScrimVisibleHeightTrigger = context.getDimensionPixelSize(C0019R.styleable.CollapsingToolbarLayout_scrimVisibleHeightTrigger, -1);
        this.mScrimAnimationDuration = (long) context.getInt(C0019R.styleable.CollapsingToolbarLayout_scrimAnimationDuration, 600);
        setContentScrim(context.getDrawable(C0019R.styleable.CollapsingToolbarLayout_contentScrim));
        setStatusBarScrim(context.getDrawable(C0019R.styleable.CollapsingToolbarLayout_statusBarScrim));
        this.mToolbarId = context.getResourceId(C0019R.styleable.CollapsingToolbarLayout_toolbarId, -1);
        context.recycle();
        setWillNotDraw(false);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05591());
    }
    ...
    static ViewOffsetHelper getViewOffsetHelper(View view) {
        ViewOffsetHelper viewOffsetHelper = (ViewOffsetHelper) view.getTag(C0019R.id.view_offset_helper);
        if (viewOffsetHelper != null) {
            return viewOffsetHelper;
        }
        viewOffsetHelper = new ViewOffsetHelper(view);
        view.setTag(C0019R.id.view_offset_helper, viewOffsetHelper);
        return viewOffsetHelper;
    }

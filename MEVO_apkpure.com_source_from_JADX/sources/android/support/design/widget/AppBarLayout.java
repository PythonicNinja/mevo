...
public class AppBarLayout extends LinearLayout {
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            attributeSet = context.obtainStyledAttributes(attributeSet, C0019R.styleable.AppBarLayout_Layout);
            this.mScrollFlags = attributeSet.getInt(C0019R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (attributeSet.hasValue(C0019R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.mScrollInterpolator = AnimationUtils.loadInterpolator(context, attributeSet.getResourceId(C0019R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i, float f) {
            ...
            if (f > 0.0f) {
                ...
                f = (int) (((((float) abs) / ((float) appBarLayout.getHeight())) + 1.0f) * 150.0f);
            }
            animateOffsetWithDuration(coordinatorLayout, appBarLayout, i, f);
        }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            context = context.obtainStyledAttributes(attributeSet, C0019R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(context.getDimensionPixelSize(C0019R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            context.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0019R.styleable.AppBarLayout, 0, C0019R.style.Widget_Design_AppBarLayout);
        ViewCompat.setBackground(this, context.getDrawable(C0019R.styleable.AppBarLayout_android_background));
        if (context.hasValue(C0019R.styleable.AppBarLayout_expanded) != null) {
            setExpanded(context.getBoolean(C0019R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (VERSION.SDK_INT >= 21 && context.hasValue(C0019R.styleable.AppBarLayout_elevation) != null) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) context.getDimensionPixelSize(C0019R.styleable.AppBarLayout_elevation, 0));
        }
        if (VERSION.SDK_INT >= 26) {
            if (context.hasValue(C0019R.styleable.AppBarLayout_android_keyboardNavigationCluster) != null) {
                setKeyboardNavigationCluster(context.getBoolean(C0019R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (context.hasValue(C0019R.styleable.AppBarLayout_android_touchscreenBlocksFocus) != null) {
                setTouchscreenBlocksFocus(context.getBoolean(C0019R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        context.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05481());
    }
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        int i2 = (this.mCollapsible && this.mCollapsed) ? C0019R.attr.state_collapsed : -C0019R.attr.state_collapsed;
        iArr[1] = i2;

...
public class BottomNavigationView extends FrameLayout {
    ...
    public BottomNavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0019R.styleable.BottomNavigationView, i, C0019R.style.Widget_Design_BottomNavigationView);
        if (attributeSet.hasValue(C0019R.styleable.BottomNavigationView_itemIconTint) != 0) {
            this.mMenuView.setIconTintList(attributeSet.getColorStateList(C0019R.styleable.BottomNavigationView_itemIconTint));
        } else {
            this.mMenuView.setIconTintList(createDefaultColorStateList(16842808));
        }
        if (attributeSet.hasValue(C0019R.styleable.BottomNavigationView_itemTextColor) != 0) {
            this.mMenuView.setItemTextColor(attributeSet.getColorStateList(C0019R.styleable.BottomNavigationView_itemTextColor));
        } else {
            this.mMenuView.setItemTextColor(createDefaultColorStateList(16842808));
        }
        if (attributeSet.hasValue(C0019R.styleable.BottomNavigationView_elevation) != 0) {
            ViewCompat.setElevation(this, (float) attributeSet.getDimensionPixelSize(C0019R.styleable.BottomNavigationView_elevation, 0));
        }
        this.mMenuView.setItemBackgroundRes(attributeSet.getResourceId(C0019R.styleable.BottomNavigationView_itemBackground, 0));
        if (attributeSet.hasValue(C0019R.styleable.BottomNavigationView_menu) != 0) {
            inflateMenu(attributeSet.getResourceId(C0019R.styleable.BottomNavigationView_menu, 0));
        }
        ...
        this.mMenu.setCallback(new C05541());
    }
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        view.setLayoutParams(new FrameLayout.LayoutParams(-1, getResources().getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_shadow_height)));
        addView(view);
    }

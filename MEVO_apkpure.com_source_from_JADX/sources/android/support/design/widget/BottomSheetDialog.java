...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C05562 extends AccessibilityDelegateCompat {
        C05562() {
        }
    ...
    class C05574 extends BottomSheetCallback {
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int i) {
        ...
        this.mBottomSheetCallback = new C05574();
    ...
    private View wrapInBottomSheet(int i, View view, LayoutParams layoutParams) {
        FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C0019R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) frameLayout.findViewById(C0019R.id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout2 = (FrameLayout) coordinatorLayout.findViewById(C0019R.id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C0019R.id.touch_outside).setOnClickListener(new C00351());
        ViewCompat.setAccessibilityDelegate(frameLayout2, new C05562());
        frameLayout2.setOnTouchListener(new C00363());
        return frameLayout;
    }
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        i = new TypedValue();
        if (context.getTheme().resolveAttribute(C0019R.attr.bottomSheetDialogTheme, i, true) != null) {
            return i.resourceId;
        }

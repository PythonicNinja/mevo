...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new C05552();
    boolean mHideable;
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        attributeSet = context.obtainStyledAttributes(attributeSet, C0019R.styleable.BottomSheetBehavior_Layout);
        TypedValue peekValue = attributeSet.peekValue(C0019R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (peekValue == null || peekValue.data != -1) {
            setPeekHeight(attributeSet.getDimensionPixelSize(C0019R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        } else {
            setPeekHeight(peekValue.data);
        }
        setHideable(attributeSet.getBoolean(C0019R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setSkipCollapsed(attributeSet.getBoolean(C0019R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int i) {
        ...
        if (this.mPeekHeightAuto != 0) {
            if (this.mPeekHeightMin == 0) {
                this.mPeekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C0019R.dimen.design_bottom_sheet_peek_height_min);
            }
            ...
            if (actionMasked != 3) {
                switch (actionMasked) {
                    case 0:
                        ...
                        v = (this.mActivePointerId == -1 && coordinatorLayout.isPointInChildBounds(v, x, this.mInitialY) == null) ? true : null;

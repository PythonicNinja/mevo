...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        i = attributeSet.getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_text_size);
        int dimensionPixelSize = attributeSet.getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = attributeSet.getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_margin);
        this.mShiftAmount = i - dimensionPixelSize;
        attributeSet = (float) dimensionPixelSize;
        i = (float) i;
        this.mScaleUpFactor = (attributeSet * 1.0f) / i;
        this.mScaleDownFactor = (i * 1065353216) / attributeSet;
        LayoutInflater.from(context).inflate(C0019R.layout.design_bottom_navigation_item, this, 1);

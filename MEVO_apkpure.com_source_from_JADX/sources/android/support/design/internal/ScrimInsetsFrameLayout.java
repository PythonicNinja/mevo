...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C05471 implements OnApplyWindowInsetsListener {
        C05471() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0019R.styleable.ScrimInsetsFrameLayout, i, C0019R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = context.getDrawable(C0019R.styleable.ScrimInsetsFrameLayout_insetForeground);
        context.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05471());
    }

    ...
    public static void handleOnClick(DialogInterface dialogInterface, int i, Activity activity, Bundle bundle) {
        if (EVENT_TYPE_ON_CLICK != null) {
            try {
                ...
                throw new RuntimeException("Event cannot be constructed", dialogInterface2);
            }
        }
        if (bundle.getBoolean(ErrorDialogManager.KEY_FINISH_AFTER_DIALOG, 0) != null && activity != null) {
            activity.finish();
        }
    }
}

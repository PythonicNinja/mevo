...
public class ErrorDialogManager {
    ...
    public static class HoneycombManagerFragment extends Fragment {
        ...
        public static void attachTo(Activity activity, Object obj, boolean z, Bundle bundle) {
            ...
            HoneycombManagerFragment honeycombManagerFragment = (HoneycombManagerFragment) activity.findFragmentByTag(ErrorDialogManager.TAG_ERROR_DIALOG_MANAGER);
            if (honeycombManagerFragment == null) {
                honeycombManagerFragment = new HoneycombManagerFragment();
                activity.beginTransaction().add(honeycombManagerFragment, ErrorDialogManager.TAG_ERROR_DIALOG_MANAGER).commit();
    ...
    public static class SupportManagerFragment extends android.support.v4.app.Fragment {
        ...
        public static void attachTo(Activity activity, Object obj, boolean z, Bundle bundle) {
            ...
            SupportManagerFragment supportManagerFragment = (SupportManagerFragment) activity.findFragmentByTag(ErrorDialogManager.TAG_ERROR_DIALOG_MANAGER);
            if (supportManagerFragment == null) {
                supportManagerFragment = new SupportManagerFragment();
                activity.beginTransaction().add((android.support.v4.app.Fragment) supportManagerFragment, ErrorDialogManager.TAG_ERROR_DIALOG_MANAGER).commit();
                activity.executePendingTransactions();
            }
    ...
    private static boolean isInExecutionScope(Object obj, ThrowableFailureEvent throwableFailureEvent) {
        if (throwableFailureEvent != null) {
            throwableFailureEvent = throwableFailureEvent.getExecutionScope();
            if (throwableFailureEvent != null && throwableFailureEvent.equals(obj) == null) {
                return null;
            }
        }
        return true;

...
public class ActivityLifecycleManager {
    ...
    private static class ActivityLifecycleCallbacksWrapper {
        ...
        private boolean registerLifecycleCallbacks(final Callbacks callbacks) {
            ...
            ActivityLifecycleCallbacks c04871 = new ActivityLifecycleCallbacks() {
            ...
            this.application.registerActivityLifecycleCallbacks(c04871);
            this.registeredCallbacks.add(c04871);
            return true;
        }
    }

...
*/
    ...
    public void throwFiveChainedExceptions() {
        try {
            ...
            throw new RuntimeException(BikeTypes.TOURING_BIKE_28, e);
        } catch (Throwable e2) {
            try {
                throw new RuntimeException(BikeTypes.USE_BIKE, e2);
            } catch (Throwable e22) {
                try {
                    throw new RuntimeException(BikeTypes.COMFORT, e22);
                } catch (Throwable e222) {
                    throw new RuntimeException(BikeTypes.CLASSIC, e222);
                }
            }
        }
    }

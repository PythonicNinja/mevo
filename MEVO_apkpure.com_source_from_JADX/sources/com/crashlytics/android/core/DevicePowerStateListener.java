...
class DevicePowerStateListener {
    ...
    class C03721 extends BroadcastReceiver {
        C03721() {
        }
    ...
    class C03732 extends BroadcastReceiver {
        C03732() {
        }
    ...
    public DevicePowerStateListener(Context context) {
        ...
        if (i != 2) {
            if (i != 5) {
                ...
                this.powerConnectedReceiver = new C03721();
                this.powerDisconnectedReceiver = new C03732();

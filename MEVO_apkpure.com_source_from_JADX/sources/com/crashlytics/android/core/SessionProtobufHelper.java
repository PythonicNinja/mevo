...
class SessionProtobufHelper {
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, String str, int i, String str2, int i2, long j, long j2, boolean z, Map<DeviceIdentifierType, String> map, int i3, String str3, String str4) throws Exception {
        ...
        if (byteString3 != null) {
            codedOutputStream2.writeBytes(14, byteString3);
        }
    }
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, RunningAppProcessInfo runningAppProcessInfo, int i, String str2, String str3, Float f, int i2, boolean z, long j2, long j3) throws Exception {
        ...
        if (byteStringForLog == null) {
            Fabric.getLogger().mo2494d(CrashlyticsCore.TAG, "No log data to include with this event.");
        }
    ...
    private static int getSessionDeviceSize(int i, ByteString byteString, ByteString byteString2, int i2, long j, long j2, boolean z, Map<DeviceIdentifierType, String> map, int i3, ByteString byteString3, ByteString byteString4) {
        int i4 = 0;
        byteString = (CodedOutputStream.computeBytesSize(1, byteString) + null) + CodedOutputStream.computeEnumSize(3, i);
        if (byteString2 == null) {
            i = 0;
        } else {
            i = CodedOutputStream.computeBytesSize(4, byteString2);
        }
        byteString = ((((byteString + i) + CodedOutputStream.computeUInt32Size(5, i2)) + CodedOutputStream.computeUInt64Size(6, j)) + CodedOutputStream.computeUInt64Size(7, j2)) + CodedOutputStream.computeBoolSize(10, z);
        if (map != null) {
            for (Entry entry : map.entrySet()) {
                byteString2 = getDeviceIdentifierSize((DeviceIdentifierType) entry.getKey(), (String) entry.getValue());
                byteString += (CodedOutputStream.computeTagSize(11) + CodedOutputStream.computeRawVarint32Size(byteString2)) + byteString2;
            }
        }
        byteString += CodedOutputStream.computeUInt32Size(12, i3);
        if (byteString3 == null) {
            i = 0;
        } else {
            i = CodedOutputStream.computeBytesSize(13, byteString3);
        }
        byteString += i;
        if (byteString4 != null) {
            i4 = CodedOutputStream.computeBytesSize(14, byteString4);
        }
        return byteString + i4;
    }

...
final /* synthetic */ class TariffRepository$$Lambda$17 implements Runnable {
    private final SimpleResponseListener arg$1;

    TariffRepository$$Lambda$17(SimpleResponseListener simpleResponseListener) {
        this.arg$1 = simpleResponseListener;
    }

    public void run() {
        this.arg$1.onResponse(false, new CantPurchaseSubscriptionWhenHasActiveRentalOrBookingException());
    }
}

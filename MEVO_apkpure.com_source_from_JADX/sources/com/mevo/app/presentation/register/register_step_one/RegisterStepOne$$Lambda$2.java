...
final /* synthetic */ class RegisterStepOne$$Lambda$2 implements Validator {
    private final RegisterStepOne arg$1;

    RegisterStepOne$$Lambda$2(RegisterStepOne registerStepOne) {
        this.arg$1 = registerStepOne;
    }

    public Pair checkValid(String str) {
        return this.arg$1.lambda$setListeners$307$RegisterStepOne(str);
    }
}

...
final /* synthetic */ class UserDetailsFragment$$Lambda$4 implements Validator {
    private final UserDetailsFragment arg$1;

    UserDetailsFragment$$Lambda$4(UserDetailsFragment userDetailsFragment) {
        this.arg$1 = userDetailsFragment;
    }

    public Pair checkValid(String str) {
        return this.arg$1.lambda$setListeners$289$UserDetailsFragment(str);
    }
}

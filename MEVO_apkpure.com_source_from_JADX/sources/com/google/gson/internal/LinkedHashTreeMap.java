...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C03981();
    ...
    static class C03981 implements Comparator<Comparable> {
        C03981() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C07601 extends LinkedTreeMapIterator<Entry<K, V>> {
            C07601() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C07611 extends LinkedTreeMapIterator<K> {
            C07611() {
                super();
            }

...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C03991();
    ...
    static class C03991 implements Comparator<Comparable> {
        C03991() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C07621 extends LinkedTreeMapIterator<Entry<K, V>> {
            C07621() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C07631 extends LinkedTreeMapIterator<K> {
            C07631() {
                super();
            }

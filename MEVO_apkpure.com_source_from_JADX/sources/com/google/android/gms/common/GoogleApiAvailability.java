        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C0380R.drawable.common_full_open_on_phone, resources.getString(C0380R.string.common_open_on_phone), pendingIntent);
                } else {

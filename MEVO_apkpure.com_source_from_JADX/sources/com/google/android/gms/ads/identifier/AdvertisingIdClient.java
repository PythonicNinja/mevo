...
*/
        /*
        r0 = r3.getPackageManager();	 Catch:{ NameNotFoundException -> 0x0053 }
        r1 = "com.android.vending";	 Catch:{ NameNotFoundException -> 0x0053 }
        r2 = 0;	 Catch:{ NameNotFoundException -> 0x0053 }
        r0.getPackageInfo(r1, r2);	 Catch:{ NameNotFoundException -> 0x0053 }
    ...
    L_0x0029:
        ...
        r1.setPackage(r4);
        r4 = com.google.android.gms.common.stats.ConnectionTracker.getInstance();	 Catch:{ Throwable -> 0x004c }
        r2 = 1;	 Catch:{ Throwable -> 0x004c }
        r3 = r4.bindService(r3, r1, r0, r2);	 Catch:{ Throwable -> 0x004c }
...
*/
    ...
    private final boolean zza(Info info, boolean z, float f, long j, String str, Throwable th) {
        ...
        hashMap.put("app_context", z ? "1" : BikeTypes.DEFAULT);
        if (info != null) {
            hashMap.put("limit_ad_tracking", info.isLimitAdTrackingEnabled() ? "1" : BikeTypes.DEFAULT);
        }

...
public final class zzku extends zzacd<zzku> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!zzach.equals(this.zzavi, zzku.zzavi) || !zzach.equals(this.zzavj, zzku.zzavj)) {
            return false;
        }
        if (this.zzavk == null) {
            if (zzku.zzavk != null) {
        ...
        if (!zzach.equals(this.zzawa, zzku.zzawa)) {
            return false;
        }
        if (this.zzafc == null) {
            if (zzku.zzafc != null) {
    ...
    protected final int zza() {
        ...
        if (this.zzavj != null && this.zzavj.length > 0) {
            i = zza;
            for (zzacj zzacj2 : this.zzavj) {
                if (zzacj2 != null) {
                    i += zzacb.zzb(3, zzacj2);
                }
            }
            zza = i;
        }
        ...
        if (this.zzawa != null && this.zzawa.length > 0) {
            for (zzacj zzacj3 : this.zzawa) {
                if (zzacj3 != null) {
                    zza += zzacb.zzb(29, zzacj3);
                }
            }
        }
        if (this.zzafc != null) {
        ...
        while (true) {
            ...
            switch (zzvl) {
                ...
                case 18:
                    ...
                    length = this.zzavi == null ? 0 : this.zzavi.length;
                    obj = new zzkr[(zzvl + length)];
                    if (length != 0) {
                        System.arraycopy(this.zzavi, 0, obj, 0, length);
                    }
                ...
                case 26:
                    ...
                    length = this.zzavj == null ? 0 : this.zzavj.length;
                    obj = new zzkx[(zzvl + length)];
                    if (length != 0) {
                        System.arraycopy(this.zzavj, 0, obj, 0, length);
                    }
                    while (length < obj.length - 1) {
                        obj[length] = new zzkx();
                        zzaca.zza(obj[length]);
                ...
                case 224:
                    ...
                    break;
                case 234:
                    zzvl = zzacm.zzb(zzaca, 234);
                    length = this.zzawa == null ? 0 : this.zzawa.length;
                    obj = new zzkp[(zzvl + length)];
                    if (length != 0) {
                        System.arraycopy(this.zzawa, 0, obj, 0, length);
                    }
                    while (length < obj.length - 1) {
                        obj[length] = new zzkp();
                        zzaca.zza(obj[length]);

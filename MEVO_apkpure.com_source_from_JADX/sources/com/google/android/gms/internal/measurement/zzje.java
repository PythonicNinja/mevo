...
public final class zzje<T extends Context & zzji> {
    ...
    public final boolean onStartJob(JobParameters jobParameters) {
        zzgn zza = zzgn.zza(this.zzabl, null, null);
        zzfi zzgi = zza.zzgi();
        String string = jobParameters.getExtras().getString(PushData.PARAM_ACTION);
        zza.zzgl();
    ...
    final /* synthetic */ void zza(int i, zzfi zzfi, Intent intent) {
    ...
    final /* synthetic */ void zza(zzfi zzfi, JobParameters jobParameters) {

...
public final class zzes {
        ...
        if (bundle == null || bundle.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (str3 == null) {
                    ...
                    Object zzh = zzgn.zzgg().zzh(str3, bundle2.get(str3));
                    if (zzh == null) {
                        zzgn.zzgi().zziy().zzg("Param value can't be null", zzgn.zzgf().zzbn(str3));
                    } else {
                        zzgn.zzgg().zza(bundle2, str3, zzh);
                    }
                }
                it.remove();
            }
    ...
    final zzes zza(zzgn zzgn, long j) {

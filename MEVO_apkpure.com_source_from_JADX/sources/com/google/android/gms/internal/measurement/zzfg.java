...
public final class zzfg extends zzhj {
    ...
    @Nullable
    protected final String zza(zzes zzes) {
        if (zzes == null) {
            return null;
        }
        if (!zziu()) {
    ...
    @Nullable
    protected final String zzb(zzex zzex) {
        if (zzex == null) {
            return null;
        }
        if (!zziu()) {
    ...
    protected final String zzbm(String str) {
        return str == null ? null : !zziu() ? str : zza(str, Event.zzacx, Event.zzacw, zzaki);
    }

    @Nullable
    protected final String zzbn(String str) {
        return str == null ? null : !zziu() ? str : zza(str, Param.zzacz, Param.zzacy, zzakj);
    }

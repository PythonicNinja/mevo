...
public class zzgn implements zzhk {
    ...
    private final void zza(zzhl zzhl) {
        ...
        zzgh().zzab();
        zzeh.zzhn();
        zzhj zzer = new zzer(this);
        zzer.zzm();
        this.zzaos = zzer;
        zzdz zzfd = new zzfd(this);
        zzfd.zzm();
        this.zzaot = zzfd;
        zzdz zzfe = new zzfe(this);
        zzfe.zzm();
        this.zzaoq = zzfe;
        zzfe = new zzik(this);
        zzfe.zzm();
    ...
    final void zzb(zzdz zzdz) {
        this.zzaox++;
    }

    final void zzb(zzhj zzhj) {
        this.zzaox++;
    }

...
public final class zzez {
    ...
    public static zza<Long> zzajb = zza.zzb("measurement.alarm_manager.minimum_interval", (long) Formatter.MINUTE, (long) Formatter.MINUTE);
    ...
    public static zza<Long> zzajk = zza.zzb("measurement.service_client.idle_disconnect_millis", (long) TopToast.DURATION_LONG, (long) TopToast.DURATION_LONG);
    ...
    public static final class zza<V> {
        ...
        private static void zzip() {
            synchronized (zza.class) {
                ...
                for (zza zza22 : zzez.zzahu) {
                    zza22.zzakc = zza22.zzaka.get();
                }
                for (zza zza222 : zzez.zzaht) {
                    zza222.zzakc = zza222.zzaka.get();
                }
                for (zza zza2222 : zzez.zzahx) {
        ...
        private static void zzm() {
            synchronized (zza.class) {
                ...
                for (zza zza2 : zzez.zzahw) {
                    ...
                    str = zza2.zzny;
                    zzee = zzez.zzahs;
                    zza2.zzaka = zzio.zzv(str, (String) zza2.zzaaa);
                }
                for (zza zza22 : zzez.zzahu) {
                    zzio = zzez.zzahy;
                    str = zza22.zzny;
                    zzee = zzez.zzahs;
                    zza22.zzaka = zzio.zze(str, ((Long) zza22.zzaaa).longValue());
                }
                for (zza zza222 : zzez.zzaht) {
                    zzio = zzez.zzahy;
                    str = zza222.zzny;
                    zzee = zzez.zzahs;
                    zza222.zzaka = zzio.zzd(str, ((Integer) zza222.zzaaa).intValue());
                }
                for (zza zza2222 : zzez.zzahx) {
                    zzio = zzez.zzahy;
                    str = zza2222.zzny;
    ...
    static {
        ...
        zzaij = zza.zzd("measurement.config.url_authority", str2, str2);
        str2 = "https://app-measurement.com/a";
        zzaiu = zza.zzd("measurement.upload.url", str2, str2);
        str = "---";
        zzajm = zza.zzd("measurement.test.string_flag", str, str);
    }

...
final class BitMatrixParser {
    ...
    byte[] readCodewords() throws FormatException {
        ...
        while (true) {
            if (i == height && i2 == 0 && r6 == null) {
                ...
                int i5 = height - 2;
                if (i == i5 && i2 == 0 && (width & 3) != 0 && r8 == null) {
                    int i6 = i3 + 1;
                    ...
                    i3 = i6;
                    obj2 = 1;
                } else if (i == height + 4 && i2 == 2 && (width & 7) == 0 && r9 == null) {
                    int i7 = i3 + 1;
                    ...
                    i3 = i7;
                    obj3 = 1;
                } else if (i == i5 && i2 == 0 && (width & 7) == 4 && r10 == null) {
                    int i8 = i3 + 1;
    ...
    BitMatrix extractDataRegion(BitMatrix bitMatrix) {
        ...
        int dataRegionSizeRows = r0.version.getDataRegionSizeRows();
        int dataRegionSizeColumns = r0.version.getDataRegionSizeColumns();

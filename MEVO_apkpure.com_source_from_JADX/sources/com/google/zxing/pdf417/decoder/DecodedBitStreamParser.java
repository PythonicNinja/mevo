...
final class DecodedBitStreamParser {
    ...
    static DecoderResult decode(int[] iArr, String str) throws FormatException {
            ...
            if (i2 != MODE_SHIFT_TO_BYTE_COMPACTION_MODE) {
                switch (i2) {
                    ...
                    case BYTE_COMPACTION_MODE_LATCH /*901*/:
                        i = byteCompaction(i2, iArr, charset, i, stringBuilder);
                        break;
                    case NUMERIC_COMPACTION_MODE_LATCH /*902*/:
                        i = numericCompaction(iArr, i, stringBuilder);
                        break;
                    default:
                        switch (i2) {
                            ...
                            case ECI_CHARSET /*927*/:
                                int i3 = i + 1;
                                Charset forName = Charset.forName(CharacterSetECI.getCharacterSetECIByValue(iArr[i]).name());
                                i = i3;
                                charset = forName;
                                break;
                            case 928:
                                i = decodeMacroBlock(iArr, i, pDF417ResultMetadata);
                                break;
                            default:
                                i = textCompaction(iArr, i - 1, stringBuilder);
                                break;
                        }
                        i = byteCompaction(i2, iArr, charset, i, stringBuilder);
                        break;
        ...
        iArr = new DecoderResult(null, stringBuilder.toString(), null, str);
        iArr.setOther(pDF417ResultMetadata);
        return iArr;
    }
    ...
    private static int decodeMacroBlock(int[] iArr, int i, PDF417ResultMetadata pDF417ResultMetadata) throws FormatException {
        ...
        i = new StringBuilder();
        int textCompaction = textCompaction(iArr, i2, i);
        pDF417ResultMetadata.setFileId(i.toString());
        if (iArr[textCompaction] == BEGIN_MACRO_PDF417_OPTIONAL_FIELD) {
            textCompaction++;
            i = new int[(iArr[0] - textCompaction)];
            Object obj = null;
            int i3 = 0;
            while (textCompaction < iArr[0] && r2 == null) {
            ...
            pDF417ResultMetadata.setOptionalData(Arrays.copyOf(i, i3));
    ...
    L_0x000d:
        r6 = r15[r2];
        r7 = com.google.zxing.pdf417.decoder.DecodedBitStreamParser.C04181.f21x45bba1d;
        r8 = r4.ordinal();
        r7 = r7[r8];
        r8 = 28;
        r9 = 27;
    ...
    private static int byteCompaction(int i, int[] iArr, Charset charset, int i2, StringBuilder stringBuilder) {
        ...
        if (i4 == BYTE_COMPACTION_MODE_LATCH) {
            ...
            while (true) {
                i9 = 0;
                long j2 = 0;
                while (i3 < iArr[0] && r18 == null) {
                    int i13 = i9 + 1;
                    iArr2[i9] = i12;
                    long j3 = (j2 * j) + ((long) i12);
                    int i14 = i3 + 1;
                    i12 = iArr[i3];
                    if (!(i12 == TEXT_COMPACTION_MODE_LATCH || i12 == BYTE_COMPACTION_MODE_LATCH || i12 == NUMERIC_COMPACTION_MODE_LATCH || i12 == BYTE_COMPACTION_MODE_LATCH_6 || i12 == 928 || i12 == r5)) {
                        if (i12 != i5) {
                            if (i13 % 5 != 0 || i13 <= 0) {
                                i3 = i14;
                                i9 = i13;
                                ...
                                i3 = 0;
                                while (i3 < 6) {
                                    byteArrayOutputStream.write((byte) ((int) (j3 >> ((5 - i3) * 8))));
                                    i3++;
                                    i5 = MACRO_PDF417_TERMINATOR;
                                    i6 = BEGIN_MACRO_PDF417_OPTIONAL_FIELD;
                                }
            ...
            while (i3 < iArr[0] && r0 == null) {
                ...
                if (i3 < TEXT_COMPACTION_MODE_LATCH) {
                    ...
                    if (i3 != TEXT_COMPACTION_MODE_LATCH && i3 != BYTE_COMPACTION_MODE_LATCH && i3 != r7 && i3 != BYTE_COMPACTION_MODE_LATCH_6 && i3 != r6) {

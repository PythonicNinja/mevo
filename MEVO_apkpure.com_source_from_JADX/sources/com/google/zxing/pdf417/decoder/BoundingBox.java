...
final class BoundingBox {
    ...
    BoundingBox addMissingRows(int i, int i2, boolean z) throws NotFoundException {
        ...
        if (i > 0) {
            ...
            i = new ResultPoint(resultPoint9.getX(), (float) y2);
            if (z) {
                resultPoint = i;
            } else {
                resultPoint2 = i;
                ...
                if (i2 <= 0) {
                    ...
                    i2 = new ResultPoint(i.getX(), (float) y);
                    if (z) {
                        resultPoint3 = i2;
                        resultPoint4 = resultPoint6;
                        calculateMinMaxValues();
                        return new BoundingBox(this.image, resultPoint, resultPoint4, resultPoint2, resultPoint3);
                    }
                    resultPoint4 = i2;
                } else {
                    resultPoint4 = resultPoint6;

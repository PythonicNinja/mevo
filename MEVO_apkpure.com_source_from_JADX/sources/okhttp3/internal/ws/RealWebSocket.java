...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random, long j) {
        if (HttpRequest.METHOD_GET.equals(request.method())) {
            ...
            this.writerRunnable = new C05251();
            return;
        }
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        final Request build = this.originalRequest.newBuilder().header("Upgrade", "websocket").header("Connection", "Upgrade").header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", BikeTypes.USE_BIKE_CLASSIC).build();

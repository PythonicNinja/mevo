...
*/
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header(HttpRequest.HEADER_CONTENT_TYPE), response.body().contentLength(), Okio.buffer(c09031))).build();
    }
    ...
    static boolean isContentSpecificHeader(String str) {
        if (!(HttpRequest.HEADER_CONTENT_LENGTH.equalsIgnoreCase(str) || HttpRequest.HEADER_CONTENT_ENCODING.equalsIgnoreCase(str))) {
            if (HttpRequest.HEADER_CONTENT_TYPE.equalsIgnoreCase(str) == null) {
                return null;
            }
        }
        return true;
